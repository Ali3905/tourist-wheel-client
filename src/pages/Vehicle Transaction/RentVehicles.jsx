...
import { columnsForRentVehicles as columns } from '../../jsonData/tableData';
import CustomTablePagination from '../../components/CustomTablePagination';
import AddButton from '../../components/addButton';
import { useDispatch, useSelector } from 'react-redux';
import { getVehiclesAsync } from '../../redux/vehiclesSlice';

const RentVehicles = () => {
  const data = useSelector(state => state.vehicles.data)

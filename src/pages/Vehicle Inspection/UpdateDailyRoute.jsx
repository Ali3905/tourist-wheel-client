...
const labels = [
    ...
    { name: 'afterJourneyPhotos', label: 'After journey Photos', type: 'file', rules: [{ required: true, message: 'Please provide the photo after journey' }] },


];

function UpdateDailyRoute() {
    ...
    useEffect(() => {
        console.log({routeId});
        setDailyRoute(activeDailyRoute(routeId))
    }, [])
                            ...
                            <Col span={12} key={index}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        dailyRoute ? <Input defaultValue={dailyRoute[field.name]} /> : "loading..."
                                    )
                                    )}
                                </Form.Item>
                            </Col>
...
export default UpdateDailyRoute;

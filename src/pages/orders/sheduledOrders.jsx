...
import { columnsForSheduledTable, dummyData } from '../../jsonData/tableData';
...
const SheduledOrders = () => {
  ...
  const filteredcolumnsForSheduledTable = columnsForSheduledTable
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: "flex-end", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", width: "51%" }}>
          ...
          <Filter columns={columnsForSheduledTable} onFilterChange={handleFilterChange} />
        </div>
      </div>
      <div style={{ backgroundColor: 'white', borderRadius: '5px', margin: '20px 0px' }}>
        ...
        <CustomTable columns={filteredcolumnsForSheduledTable} data={filteredData.slice(page * rowsPerPage, (page + 1) * rowsPerPage)} />

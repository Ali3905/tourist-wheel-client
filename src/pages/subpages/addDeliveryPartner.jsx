...
const labels = [
    ...
    { name: 'partnerType', label: 'Partner Type', type: 'select', options: ['Admin Partner', 'Vendor Partner' , 'Backup Partner'], rules: [{ required: true, message: 'Please select an identity type' }] },
    { name: 'identityType', label: 'Thaluk', type: 'select', options: ['aadhar', 'pan'], rules: [{ required: true, message: 'Please select an identity type' }] },
    { name: 'identityType', label: 'Assigned Pincode', type: 'select', options: ['aadhar', 'pan'], rules: [{ required: true, message: 'Please select an identity type' }] },
    { name: 'identityType', label: 'Sub Location', type: 'select', options: ['aadhar', 'pan'], rules: [{ required: true, message: 'Please select an identity type' }] },
    { name: 'identityType', label: 'Select head Vendor or Admin', type: 'select', options: ['Admins', 'vendors'], rules: [{ required: true, message: 'Please select an identity type' }] },
            ...
            <div {...formItemLayout}>
                <Row gutter={24}>
                    ...
                    <Col span={12} style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <Form.Item label="Partner Agreement">
                            <Upload
                                showUploadList={false}
                                beforeUpload={(file) => beforeUpload(file, setIdentityImage)}
                            >

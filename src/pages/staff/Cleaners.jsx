...
import { columnsForCleaners as columns } from '../../jsonData/tableData';
import CustomTablePagination from '../../components/CustomTablePagination';
import AddButton from '../../components/addButton';
import { useDispatch, useSelector } from 'react-redux';
import { getCleanersAsync } from '../../redux/cleanersSlice';

const Cleaners = () => {
  const data = useSelector(state => state.cleaners.data)
